            ...
            <div>
                <form action="">
                    <fieldset>
                        ...
                        <input type="text" name="guestPhoneNumber" id="guestPhoneNumber" onChange={this.handleChange} value={this.state.guestPhoneNumber} />
                        ...
                        <button onClick = {handleSubmission}>RSVP</button>
